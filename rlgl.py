...
## save second, do distance of second 2 - distance of second 1 and find the distance
## distance = speed
## if the speed is greater than 1cm/s, its moving

## Make a library and assign a variable to the first GPIO output
## Do the next GPIO output and subtract the first GPIO output from that to find speed
